...
$punyu=array(
          ...
          'BOT LIKE LATE >>',
        'Thoda Late Ho gya >>',
      'Sorry Agar Late Se Comment hua ho to >>',
   'Full Speed Ke Saath Phir Bhi Late HO gyan >>',
'like And Comment Late >>',
);
$back=array(
' :|] RobOt CReadet <3 Sumit BOT Team <3 >>',
...
$eps=$like.' '.$nm;
$ops=getJam($nm);
$site=' :|] BOT Powered By  B| SUMIT KUMAR B|  <3 For Personal And VIP BOT Site Contact On Whatsapp >> +919534701051
BOT Site >> sumitbot.blogspot,com ';
$true=$ops.'
:3 '.$eps.'
-_- '.$ups.'
 '.$ips.'
